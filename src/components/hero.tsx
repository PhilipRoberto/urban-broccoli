...
export function Hero() {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 py-12 lg:py-20 px-4 sm:px-8 lg:px-10 max-w-6xl mx-auto items-center">
      {/* Left Column */}
      <div className="flex flex-col gap-6 lg:gap-8">
        ...
        <div className="flex gap-3 sm:gap-4 flex-wrap">
          <button className="bg-gold text-ink border-none px-5 sm:px-7 py-2.5 sm:py-3 rounded font-medium cursor-pointer hover:bg-gold-light transition-colors text-xs sm:text-sm">
            Start for free
          </button>
          <button className="bg-transparent text-paper border border-border px-5 sm:px-7 py-2.5 sm:py-3 rounded font-medium cursor-pointer hover:border-muted transition-colors text-xs sm:text-sm">
            See a sample receipt
          </button>
        </div>

        {/* Stats */}
        <div className="flex gap-6 sm:gap-10 pt-6 border-t border-border">
          <div>
            <div className="font-serif text-xl sm:text-2xl text-paper leading-none mb-1">3 min</div>
